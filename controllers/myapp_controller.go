...
import (
	...
	appv1beta1 "github.com/qingfeng0101/opdemo/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=app.ydzs.io,resources=myapps/finalizers,verbs=update
...
func (r *MyappReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	los := log.FromContext(ctx, "myapp", req.NamespacedName)
	...
	los.Info("CreateOrUpdate", "Deployment", or)
	// createorupdate svc
	...
	los.Info("CreateOrUpdate", "Service", or)
